package com.demo.grpc.boot.api;
...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.boot.api.HelloProto.HelloRequest,
      com.demo.grpc.boot.api.HelloProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.demo.grpc.boot.api.HelloProto.HelloRequest.class,
      responseType = com.demo.grpc.boot.api.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.boot.api.HelloProto.HelloRequest,
      com.demo.grpc.boot.api.HelloProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.boot.api.HelloProto.HelloRequest, com.demo.grpc.boot.api.HelloProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.demo.grpc.boot.api.HelloProto.HelloRequest, com.demo.grpc.boot.api.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.boot.api.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.boot.api.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void hello(com.demo.grpc.boot.api.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.boot.api.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void hello(com.demo.grpc.boot.api.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.boot.api.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
     ...
     * </pre>
     */
    public com.demo.grpc.boot.api.HelloProto.HelloResponse hello(com.demo.grpc.boot.api.HelloProto.HelloRequest request) throws io.grpc.StatusException {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public com.demo.grpc.boot.api.HelloProto.HelloResponse hello(com.demo.grpc.boot.api.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.boot.api.HelloProto.HelloResponse> hello(
        com.demo.grpc.boot.api.HelloProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.demo.grpc.boot.api.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.boot.api.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.demo.grpc.boot.api.HelloProto.HelloRequest,
              com.demo.grpc.boot.api.HelloProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.grpc.boot.api.HelloProto.getDescriptor();
    }
