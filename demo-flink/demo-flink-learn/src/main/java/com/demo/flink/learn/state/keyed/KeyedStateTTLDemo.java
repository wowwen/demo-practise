        ...
        sensorDsWithWatermark.keyBy(WaterSensor::getId)
                .process(new KeyedProcessFunction<String, WaterSensor, String>() {
                    ...
                    public void open(Configuration parameters) throws Exception {
                        ...
                        StateTtlConfig ttlConfig = StateTtlConfig.newBuilder(Time.seconds(5)) //TTL
                                .setUpdateType(StateTtlConfig.UpdateType.OnCreateAndWrite) //更新策略： 创建和写入（包括更新），会更新TTL
                                .setStateVisibility(StateTtlConfig.StateVisibility.NeverReturnExpired)
                                .build();

                        AggregatingStateDescriptor<Integer, Tuple2<Integer, Integer>, Double> stateDescriptor =
                                new AggregatingStateDescriptor<>("agg-state",
                        ...
                        aggregatingState =
                                getRuntimeContext().getAggregatingState(stateDescriptor);
                    }
