 ...
 * @description 自定义水印生成器,周期性生成水印
 */
public class WindowCustomWatermarkDemo {
        ...
        WatermarkStrategy<WaterSensor> watermarkStrategy = WatermarkStrategy
                ...
                .<WaterSensor>forGenerator(new WatermarkStrategy<WaterSensor>() {
                    ...
                    public WatermarkGenerator<WaterSensor> createWatermarkGenerator(WatermarkGeneratorSupplier.Context context) {
                        return new MyWatermarkGeneratorPeriodGenerator<>(3000);
                    }
                })
                //指定时间戳分配器，从数据中提取
   ...
   public static class MyWatermarkGeneratorPeriodGenerator<T> implements WatermarkGenerator<T>{

       private long maxTimestamp;

       private long delay;

       public MyWatermarkGeneratorPeriodGenerator(long delay) {
           this.delay = delay;
       ...
       public void onPeriodicEmit(WatermarkOutput output) {
           ...
           System.out.println("调用onPeriodicEmit，发射的水印：" + (maxTimestamp - delay - 1));
       }
   }
}
